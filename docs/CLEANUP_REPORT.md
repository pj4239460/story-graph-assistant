...
- ✅ v0.8示例项目（已完成 2026-01-11）
- ✅ v0.8 UI改进：Storylet编辑器（已完成 2026-01-11）

### v0.8 UI改进（2026-01-11）

**新增UI组件：**
- `src/ui/storylet_editor_view.py` - 完整的Storylet可视化编辑器
  - 📚 故事块库视图（搜索、筛选、卡片展示）
  - ➕ 可视化创建/编辑表单
  - 🔗 支持v0.7顺序约束（requires_fired, forbids_fired）
  - ⚡ 动态添加/删除条件和效果
  - 💾 实时保存和验证
  - 📋 支持复制和编辑现有storylet
  - 已集成到主应用tab中（src/ui/layout.py）
